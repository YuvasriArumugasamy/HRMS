...
import { Upload, FileDown, RefreshCw, Search, AlertTriangle, Clock, Users, Check, X, Shield } from 'lucide-react';
...
const employeeData: EmployeeCompliance[] = [
  {
    id: 1,
    name: 'Sarah Johnson',
    initials: 'SJ',
    ...
    issues: [
      { field: 'Address', severity: 'Critical', smsValue: '123 Main St, New York, NY 10001', hrmsValue: '125 Main St, New York, NY 10001', lastChecked: '28/03/2026' },
      { field: 'Date of Birth', severity: 'Critical', smsValue: '1990-05-15', hrmsValue: '1990-05-14', lastChecked: '28/03/2026' },
      { field: 'Passport Number', severity: 'Critical', smsValue: 'P12345678', hrmsValue: 'P12345679', lastChecked: '28/03/2026' },
    ],
  },
  {
    id: 2,
    ...
    overallSeverity: 'Critical',
    issues: [
      { field: 'Phone', severity: 'Warning', smsValue: '+1 (555) 234-5678', hrmsValue: '+1 (555) 234-5679', lastChecked: '27/03/2026' },
      { field: 'Visa Expiry Date', severity: 'Critical', smsValue: '2027-12-31', hrmsValue: '2027-12-30', lastChecked: '27/03/2026' },
    ],
  },
  {
    id: 3,
    ...
    overallSeverity: 'Critical',
    issues: [
      { field: 'Salary', severity: 'Critical', smsValue: '$140,000', hrmsValue: '$142,000', lastChecked: '28/03/2026' },
      { field: 'Email', severity: 'Warning', smsValue: 'david.kim@company.com', hrmsValue: 'davidkim@company.com', lastChecked: '28/03/2026' },
    ],
  },
  {
    id: 4,
    ...
    issues: [
      { field: 'Address', severity: 'Warning', smsValue: '987 Cedar Ln, Chicago, IL 60601', hrmsValue: '989 Cedar Ln, Chicago, IL 60601', lastChecked: '26/03/2026' },
    ],
  },
];
...
export const ImmigrationCompliance = () => {
  ...
  // Close dropdown on outside click (if still needed for other elements)
  useEffect(() => {
    const handler = (e: MouseEvent) => {
      if (dropdownRef.current && !dropdownRef.current.contains(e.target as Node)) {
        // setShowFilterDropdown(false); // Removed as it's handled by RHFSearchableSelect
      }
    };
  ...
  // Step 1: Search across ALL issues first
  ...
  // Step 2: Apply severity filter on searched results
      ...
      <FormProvider {...methods}>
        ...
        <div className="ic-header">
          ...
          <div className="ic-header-actions">
            ...
            <button className="ic-btn-sync">
              <RefreshCw size={15} className="ic-sync-icon" /> Sync Data
            </button>
          </div>
        </div>
            ...
            <div className="ic-modal-card">
              ...
              <div className="ic-modal-body">
                ...
                <div className="ic-modal-actions">
                  ...
                  <button onClick={() => setResolveModal(null)} className="ic-modal-confirm">
                    <Check size={16} strokeWidth={3} /> Confirm Resolution
                  </button>
                </div>
              </div>
            </div>
