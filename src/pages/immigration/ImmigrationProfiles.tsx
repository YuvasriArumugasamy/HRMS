...
import { SlidersHorizontal, ChevronDown, ChevronUp, Clock, Search, CheckCircle, AlertTriangle, MapPin, Eye, ChevronRight, FileText, Check, X } from 'lucide-react';
...
const initialProfiles = [
  ...
  },
  {
    ...
    niNumber: 'CD123456E',
    passport: 'P9876543',
    permitExpiry: '30 Jun 2026',
    expiryStatus: '89 days left',
    jobTitle: 'Senior Carer',
    isKey: true,
    department: 'Care Staff',
    dataIssues: { text: '2 issues', type: 'warning', hasArrow: true },
  ...
  },
  {
    ...
    niNumber: 'EF234567F',
    passport: 'R5432109',
    permitExpiry: '30 Nov 2025',
    expiryStatus: 'Expired',
    jobTitle: 'Registered Nurse',
    isKey: true,
    department: 'Nurses',
    dataIssues: { text: '3 issues', type: 'critical', hasArrow: true },
    status: { text: 'Critical', type: 'critical' },
  }
];
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 bg-[#fafbfc] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-5 items-stretch">
        ...
        <div className="flex gap-4">
          <div className="bg-[#f0fdf4] border border-[#dcfce7] rounded-2xl px-6 py-3 flex items-center shadow-sm space-x-5 min-w-[150px]">
            <div>
          ...
          <div className="bg-[#fffbeb] border border-[#fef3c7] rounded-2xl px-6 py-3 flex items-center shadow-sm space-x-6 min-w-[150px]">
            <div>
      ...
      {/* Table Section */}
      <div className="bg-white rounded-t-xl rounded-b-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border border-gray-200 overflow-hidden">
                  ...
                  <tr key={idx} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-[13px] shadow-sm ${profile.avatarColor}`}>
                          {profile.initials}
                        </div>
                        <div>
                          <Link to={`/employees/${idx + 1}`} className="text-[14px] font-bold text-[#5542f6] hover:underline cursor-pointer">{profile.name}</Link>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      {profile.dataIssues.hasArrow && (
                        <ChevronRight size={14} className="inline-block ml-2 text-gray-400" />
                      )}
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <button className="inline-flex items-center space-x-1.5 text-[#1e7498] hover:text-[#13506b] font-bold text-[13px] px-2 transition-colors">
